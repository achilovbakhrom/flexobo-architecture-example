...
import { BOOKING_AGGREGATE_STORE } from '../../../ports/booking.repository';
...
export class AcceptBidHandler
  implements ICommandHandler<AcceptBidCommand, AcceptBidResult>
{
  constructor(
  ...
  ): Promise<Result<AcceptBidResult, Error>> {
    try {
