...
output "route53_name_servers" {
  description = "Route53 name servers (update your registrar with these)"
...
output "acm_environment_certificate_arn" {
  description = "ACM certificate ARN for dev subdomain"
  value       = module.acm.validated_environment_certificate_arn
}
...
output "registrar_update_note" {
  description = "Note about updating domain registrar"
  value       = "Update your domain registrar (flexobo.com) to use the Route53 name servers listed in route53_name_servers output"
}
